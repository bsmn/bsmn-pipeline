...
'''
    ...
    q.submit(opt(args.sample_name), 
        "{job_home}/post_2.upload_cram.sh {sample}".format(job_home=job_home, sample=args.sample_name))

    q.submit(opt(args.sample_name), 
        "{job_home}/post_3.run_variant_calling.sh {sample}".format(job_home=job_home, sample=args.sample_name))
